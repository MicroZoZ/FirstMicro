...
<div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10">
    ...
    <div class="d-flex flex-center flex-column flex-lg-row-fluid">
        ...
        <div class="w-lg-500px p-10">
            <!--begin::Form-->
            <form class="form w-100" action="{{ route('registerstore') }}" method="POST">
                <!--begin::Heading-->
                @csrf
                ...
                <div class="fv-row mb-8">
                    <!--begin::Email-->
                    <input type="text" placeholder="Type your Email" :value="__('Email')" name="email"
                ...
                <div class="fv-row mb-8">
                    <!--begin::UserName-->
                    <input type="text" placeholder="Type your name" :value="__('Name')" name="name" autocomplete="off"
                    ...
                    <div class="mb-1">
                        ...
                        <div class="position-relative mb-3">
                            <input class="form-control bg-transparent" type="password" placeholder="Password"
                                :value="__('Password')" name="password" autocomplete="off" />
                ...
                <div class="fv-row mb-8">
                    ...
                    <input placeholder="Repeat Password" :value="__('Confirm Password')" name="password_confirmation"
